/*
 * "$Id: print-escp2.c,v 1.129.2.1 2001/10/17 01:23:19 rlk Exp $"
 *
...
{
  const escp2_variable_inklist_t *inks = stp_escp2_model_capabilities[model].inks;
		 ...
		 int  *count)		/* O - Number of values */
{
  ...
  *count = 0;
  ...
  else if (strcmp(name, "Resolution") == 0)
  {
    ...
    valptrs = stp_malloc(sizeof(stp_param_t) * stp_escp2_nres);
    *count = 0;
    while (res->hres)
      {
